  ...
  <div v-if="scheduleKinou" class="scheduleKinou">
    ...
    <div class="output" :style="bgColor"></div> -->
      ...
      <section v-if="colorArea">
        <div class="DefaultPalette" v-bind:DefaultPalette="DefaultPalette">
          <div
        ...
        <!-- パステルカラー12色 -->
        <div class="PastelPalette" v-bind:PastelPalette="PastelPalette">
          <br />
          <div
        ...
        <!-- グラデーション11色 -->
        <div class="GradationColor" v-bind:GradationColor="GradationColor">
          <br />
          <div
        ...
        <!-- ミックス6色 -->
        <div class="MixColor" v-bnd:MixColor="MixColor">
          <br />
          <div
